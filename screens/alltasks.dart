...
import 'package:mobileapp1/widgets/task_widget.dart';
import 'package:get/get.dart';
                        ...
                        showModelBottomSheet(
                            ...
                            builder: (_) {
                              return Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInserts.only(left: 20, right: 20),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    ButtonWidget(bgcolor: AppColors.mainColor, text: "view", textColor: Colors.white)
                                    SizedBox(height:20,),
                                    ButtonWidget(bgcolor: AppColors.mainColor, text: "Edit", textColor: Colors.white)
                                  ],
                                )),
                              );
                            });
